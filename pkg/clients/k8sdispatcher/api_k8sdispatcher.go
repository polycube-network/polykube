...
/*
K8sdispatcherApiService Read client-subnet by ID
...
@return string
*/
func (a *K8sdispatcherApiService) ReadK8sdispatcherClientSubnetByID(ctx context.Context, name string) (string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/k8sdispatcher/{name}/client-subnet/"
	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", fmt.Sprintf("%v", name), -1)
...
/*
K8sdispatcherApiService Read cluster-ip-subnet by ID
...
@return string
*/
func (a *K8sdispatcherApiService) ReadK8sdispatcherClusterIpSubnetByID(ctx context.Context, name string) (string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/k8sdispatcher/{name}/cluster-ip-subnet/"
	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", fmt.Sprintf("%v", name), -1)
...
/*
K8sdispatcherApiService Read internal-src by ID
...
@return string
*/
func (a *K8sdispatcherApiService) ReadK8sdispatcherNodeportRuleInternalSrcByID(ctx context.Context, name string, nodeportPort int32, proto string) (string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/k8sdispatcher/{name}/nodeport-rule/{nodeport-port}/{proto}/internal-src/"
	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", fmt.Sprintf("%v", name), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"nodeport-port"+"}", fmt.Sprintf("%v", nodeportPort), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"proto"+"}", fmt.Sprintf("%v", proto), -1)
...
/*
K8sdispatcherApiService Update client-subnet by ID
...
*/
func (a *K8sdispatcherApiService) UpdateK8sdispatcherClientSubnetByID(ctx context.Context, name string, clientSubnet string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
K8sdispatcherApiService Update cluster-ip-subnet by ID
...
*/
func (a *K8sdispatcherApiService) UpdateK8sdispatcherClusterIpSubnetByID(ctx context.Context, name string, clusterIpSubnet string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
K8sdispatcherApiService Update internal-src by ID
Update operation of resource: internal-src
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name ID of name
 * @param nodeportPort ID of nodeport-port
 * @param proto ID of proto
 * @param internalSrc Source IP address


*/
func (a *K8sdispatcherApiService) UpdateK8sdispatcherNodeportRuleInternalSrcByID(ctx context.Context, name string, nodeportPort int32, proto string, internalSrc string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
